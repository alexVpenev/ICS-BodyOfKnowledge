    ...
    <nav class="navbar-links">
      <div class="navbar-links-wrapper">
        <ul>
          ...
          <li class="common"><a href="src/pages/introduction.php">Introduction</a></li>
          <li class="common"><a href="src/pages/versionHistory.php">Version Control</a></li>
          ...
          <li class="subsubsection1"><a href="src/pages/basic-hacking-and-pentesting-process.php">Basic Hacking and Pentesting Process</a></li>
          <li class="subsubsection1"><a href="src/pages/threat-and-risk-analysis-pt1-cia.php">Threat & Risk Analysis Part 1</a></li>

          <li class="subsection1"><a href="#">Web Application Attack and Defense</a></li>
          <li class="subsubsection1"><a href="src/pages/installing-dvwa-and-juice-shop.php">Install Vulnerable Web App</a></li>
          <li class="subsubsection1"><a href="src/pages/footprinting-reconnaissance-social-engineering.php">Footprinting, Reconnaissance and Social Engineering</a></li>

          <li class="subsection1"><a href="#">Web Site Attack and Defense</a></li>
          <li class="subsubsection1"><a href="src/pages/path-traversal-file-inclusion-command-injection.php">Path Traversal, (remote) File inclusion and Command Injection</a></li>
          <li class="subsubsection1"><a href="src/pages/web-application-firewall.php">Web Application Firewalls</a></li>
          <li class="subsubsection1"><a href="src/pages/host-intrusion-detection-prevention.php">Host Intrusion Detection and Prevention (HIDS)</a></li>
          <li class="subsubsection1"><a href="src/pages/xss-csrf.php">XSS & CSRF</a></li>


          <li class="subsection1"><a href="#">Web: Database Attack and Defense</a></li>
          <li class="subsubsection1"><a href="src/pages/sql-injection.php">SQL Injection</a></li>
          ...
          <li class="subsubsection2"><a href="src/pages/network-separation-segmentation.php">Network Separation and Segmentation</a></li>
          ...
          <li class="subsubsection2"><a href="src/pages/sniffing-spoofing.php">Network Spoofing and Man in The Middle Attacks(MITM)</a></li>
